...
This folder is the region-default content layer for `reg15`.
...
- `regions/reg15/data/primary-assets.json`
- `regions/reg15/data/primary.json`
- `regions/reg15/data/footer.json`
- `regions/reg15/data/primaryending.json`
- `regions/reg15/assets/primary/manifest.json`
- `regions/reg15/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg15`.
